...
<title>OnFD Edit Vendor Details</title>
</head>
<body>
	<%@include file="nav_bar.jsp"%>
	<center>
		<form:form action="/vendor/edit" method="post" name="edit" id="edit"
			modelAttribute="user"
			...
			<table class="edit">
				...
				<tr>
					...
					<td><form:input class="name" path="company" /></td>
				</tr>
				<tr>
